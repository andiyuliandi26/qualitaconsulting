...
class Auth extends MY_Controller
{
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->_render_page('administrator/auth' . DIRECTORY_SEPARATOR . 'forgot_password', $this->data);
		}
		else
		{
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() === FALSE)
			{
				...
				// render
				$this->_render_page('administrator/auth' . DIRECTORY_SEPARATOR . 'reset_password', $this->data);
			}
			else
			{
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			$this->_render_page('administrator/auth' . DIRECTORY_SEPARATOR . 'deactivate_user', $this->data);
		}
		else
		{
	...
	public function create_user()
	{
		...
		if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data))
		{
			...
			$this->session->set_flashdata('message', $this->ion_auth->messages());
			redirect("administrator/auth/users", 'refresh');
		}
		else
		{
			...
			$this->load->view("layouts/header");
			$this->load->view("layouts/nav");
			$this->_render_page('administrator/auth' . DIRECTORY_SEPARATOR . 'create_user', $this->data);      
			$this->load->view("layouts/footer");
		}
	}
	/**
	...
	*/
	...
	public function create_group()
	{
		...
		$this->load->view("layouts/header");
		$this->load->view("layouts/nav");
		$this->_render_page('administrator/auth/create_group', $this->data);     
		$this->load->view("layouts/footer");
	...
	public function edit_group($id)
	{
		...
		$this->load->view("layouts/header");
		$this->load->view("layouts/nav");
		$this->_render_page('administrator/auth' . DIRECTORY_SEPARATOR . 'edit_group', $this->data); 
		$this->load->view("layouts/footer");
