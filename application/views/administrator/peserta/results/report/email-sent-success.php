...
<div class="container">
	...
	<div class="d-none d-md-block">
		<h1 class="display-3">
			Selamat, <?php echo $peserta->NamaPeserta; ?>
		</h1>
	</div>
	...
	<p class="lead">
		<?php
			...
			echo "Anda telah menyelesaikan profiling qualita selama {$durasi} menit. Hasil dari profiling Anda telah di kirim ke alamat e-mail  <strong>{$peserta->Email}</strong>."; ?>
	</p>
	<p>
		Apabila Anda tidak menerima email tersebut, Anda dapat menghubungi administrator di nomor Whatsapp
