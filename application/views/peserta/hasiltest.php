<div class="d-print-flex card m-3">
    <div class="card-body">
        ...
        <div class="d-print-flex row border ml-0 mr-0 p-2">
        ...
        <div class="d-print-flex row border mt-3 ml-0 mr-0 p-2 justify-content-center">        
            <div class="col-md-8 col-lg-8 col-sm-12 col-12" id="chartContainer">
